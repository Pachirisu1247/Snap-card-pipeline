...
- small global leftward bias to correct consistent right-shift
"""
    ...
    function buildRelayoutScript(psdName) {
      ...
      return `
        (function () {
          ...
          // Small global left shift to correct consistent rightward bias.
          var leftBias = -12;

          var dx = (centerX(ab) - centerX(lb)) + leftBias;
          ...
          try {
            ...
            app.echoToOE("DBG:leftBias:" + leftBias);
          } catch (e) {
          ...
          while (iter < 25) {
            ...
            var dx2 = (centerX(ab) - centerX(lb)) + leftBias;
